                        ...
                        <div className="col-lg-6">
                            <div className="ln-about-left-side p-relative full-height">
                                <div className="first-img full-height">
                                    <img src={process.env.PUBLIC_URL + "/assets/images/homepage/about2.jpg"} className="image-fit" alt="img" />
                                </div>
                                <div className="second-img">
                                    <img src={process.env.PUBLIC_URL + "/assets/images/homepage/about1.jpg"} className="image-fit" alt="img" />
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                  ...
                  Less Interest </li>
                                    ...
                                    <div className="lw-about-right-author">
                                        ...
                                        <div className="lw-about-sign-image">
                                            <img src={process.env.PUBLIC_URL + "/assets/images/signature.png"} alt="sign" />
                                        </div>
                                    </div>
                                </div>
                            </div>
