...
import SalariedNewLoanForm from './SalariedNewLoanForm';
import SalariedBalTransfer from './SalariedBalTransfer';
import SelfEmployedProfessionalForm from './SelfEmployedProfessionalForm';
import SelfEmployedBusinessmanForm from './SelfEmployedBusinessmanForm';
    ...
    return (
        <div>
            <div className="contact-form full-height align-self-center">
                <div className="div-layout-1 form-layout-1">
                    <div className="row">
