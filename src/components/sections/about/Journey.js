                        ...
                        <div className="col-lg-12">
                            <div className="tabs square-tabs"> 
                                <Tab.Container defaultActiveKey="tab1">
                                    <Nav variant="tabs" className="nav nav-tabs custom p-relative mb-xl-30">
                                        <Nav.Item>
                                            <Nav.Link eventKey="tab1">1990</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="tab2">2006</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="tab3">2010</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="tab4">2021</Nav.Link>
                                        </Nav.Item>
                                    </Nav>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-6">
                                                        <div className="img-sec mb-md-40">
                                                            <img src={process.env.PUBLIC_URL + "/assets/images/about-4.jpg"} className="full-width" alt="img" />
                                                        </div>
                                                    </div>
                                        ...
                                        <Tab.Pane eventKey="tab2">
                                            <div className="tab-inner">
                                                <div className="row">
                                                    <div className="col-lg-6">
                                                        <div className="img-sec mb-md-40">
                                                            <img src={process.env.PUBLIC_URL + "/assets/images/about2.jpg"} className="full-width" alt="img" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6 align-self-center">
                                                        <div className="content-box">
